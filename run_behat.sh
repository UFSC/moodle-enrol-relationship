#!/bin/bash
# =============================================================================
# run_behat.sh - Executa testes Behat do plugin enrol_relationship via Docker
#
# Uso:
#   ./run_behat.sh                                  # Roda todos os testes @enrol_relationship
...
PLUGIN_COMPONENT="enrol_relationship"
PLUGIN_RELPATH="enrol/relationship"
PLUGIN_TAG="@enrol_relationship"
