...
namespace enrol_relationship\task;
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class enrol_relationship_sync extends \core\task\scheduled_task {
    ...
    public function get_name() {
        return get_string('enrolrelationshipsynctask', 'enrol_relationship');
    }

    /**
     * Run task for syncing relationship enrolments.
     */
